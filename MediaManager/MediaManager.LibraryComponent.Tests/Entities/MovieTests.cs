...
namespace MediaManager.LibraryComponent.Tests.Entities
{
  [TestFixture]
  public class MovieTests
  {
    private readonly Movie _movie = Movie.CreateMovie("Test Title", "Awesome summary", DateTime.Today, "1999", "posterUrl", true, MovieMpaaRating.G, Format.Dvd,"imdbId", "testUser");
