...
{
  [TestFixture]
  public class ApprovedRatingUnitTests
  {
    [TestCase("APPROVED", "NOTRATED")]
    public void ValidateApprovedRating_ReplacesWithCorrectRating(string rating, string expectedRating)
    {
