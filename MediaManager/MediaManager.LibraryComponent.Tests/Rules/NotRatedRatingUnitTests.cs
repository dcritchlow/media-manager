...
{
  [TestFixture]
  public class NotRatedRatingUnitTests
  {
    [TestCase("NOT RATED", "NOTRATED")]
    public void ValidateNotRatedRating_ReplacesWithCorrectRating(string rating, string expectedRating)
    {
