...
{
  [TestFixture]
  public class NotApplicableRatingUnitTests
  {
    [TestCase("N/A", "NOTRATED")]
    public void ValidateNotApplicableRating_ReplacesWithCorrectRating(string rating, string expectedRating)
    {
