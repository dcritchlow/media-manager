...
{
  [TestFixture]
  public class PassedRatingUnitTests
  {
    [TestCase("PASSED", "NOTRATED")]
    public void ValidatePassedRating_ReplacesWithCorrectRating(string rating, string expectedRating)
    {
